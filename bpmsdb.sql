...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2022 at 12:44 PM
...
CREATE TABLE `admin` (
  ...
  `franch_name` varchar(200) NOT NULL,
...
INSERT INTO `admin` (`id`, `name`, `franch_name`, `contact`) VALUES
(3, 'Parth madhvani', 'Kataragam', ' 4545454545'),
(4, 'Deep ', 'Adajan', ' 9999999999'),
(5, 'Kenil ', 'Pal', ' 1234567890'),
(6, 'deepak', 'Mota Varachha', ' 1111111111');
...
INSERT INTO `tblappointment` (`ID`, `AptNumber`, `Name`, `Email`, `PhoneNumber`, `AptDate`, `AptTime`, `Services`, `ApplyDate`, `Remark`, `Status`, `RemarkDate`, `Location`) VALUES
...
(8, '792037480', 'Deep ', 'deep@gma.com', 7990318577, '5/5/2022', '1:00am', 'Rebonding', '2022-04-13 14:22:30', 'this boy is cool', '1', '2022-04-14 11:20:34', 'Adajan'),
(9, '518391723', 'Kenil ', 'kskevadiya2002@gmail.com', 7990318579, '4/27/2022', '3:00am', 'Deluxe Menicure', '2022-04-13 14:22:48', '', '', NULL, 'Pal'),
(10, '179188259', 'Username', 'email@gmail.com', 7990318577, '5/13/2022', '1:00am', '', '2022-04-13 15:59:11', '', '', NULL, 'Adajan'),
(11, '636115953', 'czx', 'nissa@gmail.comx', 7790318570, '5/5/2022', '12:30am', 'Deluxe Pedicure', '2022-04-13 16:10:22', '', '', NULL, 'Pal'),
(12, '116165002', 'Username', 'email@gmail.commmw', 7990318577, '3/29/2022', '12:30am', 'Deluxe Menicure,Deluxe Pedicure,Normal Menicure,', '2022-04-13 16:20:15', '', '', NULL, 'Kataragam'),
(13, '341163745', 'dhruv', 'dhruvisnegative@gmail.com', 7790318570, '5/5/2022', '12:30am', 'Normal Pedicure,Layer Haircut,Rebonding,Body Spa,', '2022-04-14 10:55:14', 'this boy is fool', '2', '2022-04-14 11:18:23', 'Adajan'),
(16, '189809783', 'Dhruvil', 'dhruvil@gmail.com', 9537083330, '4/21/2022', '12:30am', 'O3 Facial,Fruit Facial,Charcol Facial,', '2022-04-23 04:05:01', 'DONE', '1', '2022-04-23 04:11:28', 'Adajan');
...
INSERT INTO `tblcustomers` (`ID`, `Name`, `Email`, `MobileNumber`, `Gender`, `Details`, `CreationDate`, `UpdationDate`, `Location`) VALUES
...
(6, 'Dhruvil', 'dhruvil@gmail.com', 1234567890, 'Male', 'ddd', '2022-04-23 04:26:25', NULL, '');
...
(19, 6, 1, 994999284, '2022-04-23 04:26:50'),
(20, 6, 2, 994999284, '2022-04-23 04:26:50');
...
(2, 'contactus', 'Contact Us', '        Surat', 'goaldiggers@gmail.com', 7990318570, NULL, '10:30 am to 7:30 pm');
